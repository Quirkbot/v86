...
FS.prototype.OnJSONLoaded = function(fs)
{
    if(DEBUG)
    {
        window.console.assert(fs, "Invalid fs passed to OnJSONLoaded");
    }
    ...
    setTimeout(function()
    {
        ...
        //window.console.profile("Load");
        for(var i = 0; i < fsroot.length; i++) {
            me.LoadRecursive(fsroot[i], 0);
        }
        //window.console.profileEnd("Load");
        //window.console.timeEnd("Load");

        //if(DEBUG)
        //{
        //    window.console.time("Check");
        //    me.Check();
        //    window.console.timeEnd("Check");
        //}
...
FS.prototype.CreateInode = function() {
    //window.console.log("CreateInode", Error().stack);
